...
// ✅ import images properly for Vite/React
...
const WHY = [
  {
    icon: "🌿",
    title: "100% Ayurvedic",
    body: "Every ingredient sourced from nature's finest — no synthetic fillers, no shortcuts.",
  },
  {
    icon: "🧪",
    title: "Lab Certified",
    body: "Each batch independently tested for purity, potency and safety.",
  },
  {
    icon: "❄️",
    title: "Cold-Pressed",
    body: "Minimal processing preserves the full spectrum of botanical actives.",
  },
  {
    icon: "👨‍⚕️",
    title: "Doctor Trusted",
    body: "Formulations developed with certified Ayurvedic physicians.",
  },
];
    ...
    <>
      ...
      <section className="hero-section">
        <div className="hero-main">
          {prev && (
            <div className={`hero-img-layer ${direction === "next" ? "exiting" : "exiting"}`}>
              <img
                src={prev.img}
                alt=""
          ...
          <div className="hero-controls">
            ...
            <div className="nav-arrows">
              <button type="button" className="nav-arrow" onClick={prevSlide}>
                ←
              </button>
              <button type="button" className="nav-arrow" onClick={nextSlide}>
                →
              </button>
            </div>
          </div>
      ...
      <section
        id="about"
        className={`why ${whyVisible ? "why-visible" : ""}`}
        ref={whyRef}
      >
        <div className="why-header">
          <h2 className="why-heading">
            Rooted in{" "}
            <span style={{ color: "#2D5344", fontStyle: "italic" }}>
              Nature
            </span>
            , Backed by Science
          </h2>
      ...
      >
        ...
        >
          © 2026 NITHYA AYURVEDA — Pune, MH
        </p>
      </footer>

      {toast && <div className="cart-toast">🛒 {toast} added to cart!</div>}
    </>
  );
} 